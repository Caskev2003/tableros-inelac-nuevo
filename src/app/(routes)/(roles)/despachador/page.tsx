...
import { GestionAlmacenRefaccionesDespachador } from "../components/GestionAlmacenRefaccionesDespachador";
import { GestionAlmacenQuimicosDespachador } from "../components/GestionAlmacenQuimicosDespachador";
  ...
  return (
    <div className="relative bg-[#2b2b2b] min-h-screen overflow-hidden">
      ...
      <div className="flex flex-col md:flex-row items-center justify-center gap-8 md:gap-20 lg:gap-36 w-full px-4">
        <GestionAlmacenRefaccionesDespachador/>
        <GestionAlmacenQuimicosDespachador/>

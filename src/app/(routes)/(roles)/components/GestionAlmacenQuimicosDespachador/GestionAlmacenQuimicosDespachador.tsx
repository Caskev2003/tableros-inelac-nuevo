...
export function GestionAlmacenQuimicosDespachador() {
      ...
      {showMenu && (
        <div className="absolute flex flex-col gap-3 right-[-115px] md:right-[-130px] lg:right-[-150px] top-9">
          ...
          <button
            ...
            onClick={() => handleNavigation("/despachador_gestion_inventarios_quimicos")}
          >
           ...
           <button
            ...
            onClick={() => handleNavigation("/despachador_historial_movimientos_quimicos")}
          >
          ...
          <button
            className="bg-[#0D0A62] text-white text-xs md:text-sm px-3 py-2 rounded-full shadow-lg 
            transition-all duration-300 cursor-pointer hover:bg-blue-500 border-white border-2"
            onClick={() => handleNavigation("/despachador_dashboard_quimicos")}
          >
            📊 Dashboard
          </button>
        </div>
